...
# Como as variâncias estimadas são diferentes (p-valor < 0,05), fazemos o seguinte teste para a amostra com 50 observações:

t.test(amostra$NOTA_MT, amostra$NOTA_LP, mu = 0, var.equal = FALSE)
